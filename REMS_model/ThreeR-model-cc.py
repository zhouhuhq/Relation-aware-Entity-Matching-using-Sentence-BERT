...
def compute_score(pred_list,label_list):
    accuracy = sklearn.metrics.accuracy_score(pred_list, label_list)
    recall = sklearn.metrics.recall_score(pred_list, label_list, average='weighted')
    f1 = sklearn.metrics.f1_score(pred_list, label_list, average='weighted')
...
if __name__=="__main__":
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=700,evaluation_steps_num=1400)
    ...
    path_c = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/BP_test_dataset.csv'
    path_d = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/BP_error_dataset.csv'
    BertEM(path_a,path_b,path_c,path_d,epochs_num=5,warmup_steps_num=600,evaluation_steps_num=1200)
