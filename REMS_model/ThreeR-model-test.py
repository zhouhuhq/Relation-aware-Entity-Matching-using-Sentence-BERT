...
if __name__=="__main__":
    ...
    #Dirty-iTunes-Amazon
    path_a = '/ssd/zhouhcData/deepmatcherData/Dirty/iTunes-Amazon/train_dataset.csv'
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=500,evaluation_steps_num=1000)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=220,evaluation_steps_num=400)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=4,warmup_steps_num=80,evaluation_steps_num=160)
