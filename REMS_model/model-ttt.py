...
def BertEM(path_train, path_valid, path_test, path_error,epochs_num, warmup_steps_num, evaluation_steps_num):
    ...
    model = SentenceTransformer('distilbert-base-nli-stsb-mean-tokens',device='cuda:2')
...
if __name__=="__main__":
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=7,warmup_steps_num=80,evaluation_steps_num=160)
    ...
    # path_a = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/train_dataset.csv'
    ...
    BertEM(path_a,path_b,path_c,path_d,epochs_num=3,warmup_steps_num=1200,evaluation_steps_num=2400)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=4,warmup_steps_num=6000,evaluation_steps_num=20)
