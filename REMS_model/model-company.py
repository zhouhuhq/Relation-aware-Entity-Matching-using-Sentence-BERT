...
def BertEM(path_train, path_valid, path_test, path_error,epochs_num, warmup_steps_num, evaluation_steps_num):
    ...
    model = SentenceTransformer('distilbert-base-nli-stsb-mean-tokens',device='cuda:6')
    #model = SentenceTransformer('roberta-large-nli-stsb-mean-tokens',device='cuda:4')
    data_type = {"text_a": str, "text_b": str}
    #截断
    def auto_truncate(val):
        return val[:1500]
    train_data = pd.read_csv(path_train, converters={'text_a':auto_truncate, 'text_b':auto_truncate})
    valid_data = pd.read_csv(path_valid, converters={'text_a':auto_truncate, 'text_b':auto_truncate})
    test_data = pd.read_csv(path_test, converters={'text_a':auto_truncate, 'text_b':auto_truncate})
...
if __name__=="__main__":
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=1,warmup_steps_num=20,evaluation_steps_num=40)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=4,warmup_steps_num=50,evaluation_steps_num=100)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=100,evaluation_steps_num=200)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=1,warmup_steps_num=600, evaluation_steps_num=1200)
    ...
    # path_c = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/BP_test_dataset.csv'
    # path_d = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/BP_error_dataset.csv'
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=600,evaluation_steps_num=1200)
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=3,warmup_steps_num=1200,evaluation_steps_num=500)
    ...
    BertEM(path_a,path_b,path_c,path_d,epochs_num=4,warmup_steps_num=6000,evaluation_steps_num=12000)
