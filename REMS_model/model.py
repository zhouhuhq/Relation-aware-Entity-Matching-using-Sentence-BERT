...
#model = SentenceTransformer('bert-base-nli-cls-token',device='cuda:1')
#model = SentenceTransformer('roberta-large-nli-mean-tokens',device='cuda:1')
#model = SentenceTransformer('bert-base-wikipedia-sections-mean-tokens',device='cuda:2')
#model = SentenceTransformer('distilbert-base-nli-max-tokens',device='cuda:2')  
#model = SentenceTransformer('bert-large-nli-stsb-mean-tokens',device='cuda:2')
#model = SentenceTransformer('roberta-large-nli-stsb-mean-tokens',device='cuda:1')
#model = SentenceTransformer('nli-roberta-base',device='cuda:1')
...
if __name__=="__main__":
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=15,warmup_steps_num=30,evaluation_steps_num=60)
    ...
    # #Structured-DBLP-ACM
    # path_a = '/ssd/zhouhcData/deepmatcherData/Structured/DBLP-ACM/delete_authors_train_dataset.csv'
    # path_b = '/ssd/zhouhcData/deepmatcherData/Structured/DBLP-ACM/valid_dataset.csv'
    # path_c = '/ssd/zhouhcData/deepmatcherData/Structured/DBLP-ACM/test_dataset.csv'
    # path_d = '/ssd/zhouhcData/deepmatcherData/Structured/DBLP-ACM/error_dataset.csv'
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=6,warmup_steps_num=700,evaluation_steps_num=2100)
    ...
    # path_a = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/del_train_dataset.csv'
    ...
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=4,warmup_steps_num=1200,evaluation_steps_num=2400)
    ...
    # #Textual-Company
    # path_a = '/ssd/zhouhcData/deepmatcherData/Textual/Company/SummAug_train_dataset.csv'
    # path_b = '/ssd/zhouhcData/deepmatcherData/Textual/Company/SummAug_valid_dataset.csv'
    # path_c = '/ssd/zhouhcData/deepmatcherData/Textual/Company/SummAug_test_dataset.csv'
    # path_d = '/ssd/zhouhcData/deepmatcherData/Textual/Company/SummAug_error_dataset.csv'
    # BertEM(path_a,path_b,path_c,path_d,epochs_num=3,warmup_steps_num=6000,evaluation_steps_num=3000)
