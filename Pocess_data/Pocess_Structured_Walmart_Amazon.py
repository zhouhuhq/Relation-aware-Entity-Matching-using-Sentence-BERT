...
path_tmp = '/ssd/zhouhcData/deepmatcherData/Structured/Walmart-Amazon/tmp.csv'
...
tableA['text_a'] = tableA['title'] + ' ' + tableA['category'] + ' ' + tableA['brand'] + ' ' + tableA['modelno'] + ' ' + tableA['modelno'] 
tableB['text_b'] = tableB['title'] + ' ' + tableB['category'] + ' ' + tableB['brand'] + ' ' + tableB['modelno'] + ' ' + tableB['modelno'] 
