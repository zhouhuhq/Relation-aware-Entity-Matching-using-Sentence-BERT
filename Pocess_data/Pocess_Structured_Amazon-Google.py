...
#定义路径
path_train = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/train.csv'
path_valid = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/valid.csv'
path_test = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/test.csv'
path_a = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/tableA.csv'
path_b = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/tableB.csv'
path_train_dataset = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/train_dataset.csv'
path_valid_dataset = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/valid_dataset.csv'
path_test_dataset = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/test_dataset.csv'
path_train_DA = '/ssd/zhouhcData/deepmatcherData/Structured/Amazon-Google/DA_train_dataset.csv'
#读取预处理需要的所有表格
...
tableA['manufacturer'] = tableA['manufacturer'].map(lambda x: str(x))
tableA['price'] = tableA['price'].map(lambda x: str(x))
tableB['title'] = tableB['title'].map(lambda x: str(x))
tableB['manufacturer'] = tableB['manufacturer'].map(lambda x: str(x))
tableB['price'] = tableB['price'].map(lambda x: str(x))


tableA.insert(tableA.shape[1],'text_a', 0)
tableB.insert(tableB.shape[1],'text_b', 0)
tableA['text_a'] = tableA['title'] + ' ' + tableA['manufacturer'] + ' ' + tableA['price']
tableB['text_b'] = tableB['title'] + ' ' + tableB['manufacturer'] + ' ' + tableB['price']
...
train_data.to_csv(path_train_DA,index=0)
print(len(train_data))
